    ...
    <div className="bg-paper min-h-screen">
      ...
      <div className="bg-slate-900 pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-serif text-white mb-6">Encontre Dentistas</h1>
          <p className="text-gray-400 font-light text-xl max-w-2xl mx-auto">
            Conectando você aos melhores dentistas e especialistas do Brasil.
          </p>
        </div>
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-md p-6 rounded-2xl shadow-xl border border-white/50 max-w-5xl mx-auto mb-12">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div className="flex items-center gap-3">
               ...
               <div>
                  <h2 className="text-slate-900 font-bold text-lg">Filtrar Dentistas</h2>
            ...
            {filteredProfiles.length === 0 ? (
              <div className="text-center py-24 bg-white rounded-2xl border border-dashed border-gray-200 shadow-sm">
                ...
                <h3 className="text-xl font-serif text-slate-900 mb-2">
                  {selectedState ? 'Nenhum dentista encontrado' : 'Selecione uma região no mapa'}
                </h3>
                <p className="text-gray-500">
                  {selectedState 
                    ? 'Tente ajustar os filtros para encontrar dentistas.' 
                    : 'Clique em um estado no mapa acima para ver os dentistas disponíveis.'}
                </p>
              </div>
            ) : (
              <div className="space-y-6">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-2xl font-serif text-slate-900">
                    {filteredProfiles.length} {filteredProfiles.length === 1 ? 'Dentista Encontrado' : 'Dentistas Encontrados'}
                  </h3>
                </div>
                      ...
                      <div className="p-6">
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="shrink-0">
                            <div className="w-24 h-24 rounded-xl bg-linear-to-br from-primary/20 to-primary/5 flex items-center justify-center">
          ...
          <div className="max-w-5xl mx-auto">
            {filteredProfiles.length === 0 ? (
              <div className="text-center py-24 bg-white rounded-2xl border border-dashed border-gray-200 shadow-sm">
                ...
                <h3 className="text-xl font-serif text-slate-900 mb-2">
                  {selectedState ? 'Nenhum dentista encontrado' : 'Selecione uma região'}
                </h3>
                <p className="text-gray-500">
                  {selectedState 
                    ? 'Tente ajustar os filtros para encontrar dentistas.' 
                    : 'Utilize os filtros acima ou a visão de mapa para encontrar dentistas.'}
                </p>
              </div>
            ) : (
              <div className="space-y-6">
